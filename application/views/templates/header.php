        ...
        <div class="container">
            ...
            <div id="navbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="<?php echo base_url(); ?>categories/create">Nouvelle catégorie</a></li>
                    <li><a href="<?php echo base_url(); ?>users/allMembers">Gestion des membres</a></li>
                    <?php endif; ?>
                    
                    <?php if($this->session->userdata('logged_in')) : ?>
                    <li><a href="<?php echo base_url(); ?>users/profile">Profil</a></li>
